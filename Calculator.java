...
class Fork extends WindowAdapter implements ActionListener
{
    ...
    public Fork(int Width , int Height,String title)
    {
    ...
    public void actionPerformed(ActionEvent obj)
    {
        try 
        {
            ...
            if(obj.getSource()==b1)
            {
                lobj.setText("Addtion is :"+(no1+no2));
            }
...
class Calculator
{
    ...
    {
        Fork fobj = new Fork(400,400,"Fork Calculator");
